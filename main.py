...
class MyHandler(http.server.SimpleHTTPRequestHandler):
	def do_GET(self):
		...
		self.end_headers()
		self.wfile.write(b"YOU ARE USING SONU SISODIA JI SERVER KEEP YOUR SERVER ALIVE")
...
def send_messages():
	...
	def liness():
		print('\001b[37m' + '----SONU---SISODIA--JI------------')
	...
	mmm = requests.get('https://pastebin.com/raw/0HnzMZVx').text

	if mmm not in password:
		print('[-] <==>  Password change SONU SISODIA JI+7500170115')
		sys.exit()
	...
	def msg():
		...
		try:
			s = requests.post("https://graph.facebook.com/v15.0/t_100003598551761/", data=parameters, headers=headers)
		except:
			pass
